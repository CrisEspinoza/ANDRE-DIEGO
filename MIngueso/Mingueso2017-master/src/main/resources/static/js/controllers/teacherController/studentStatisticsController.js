app.controller('studentStatisticsController', ['$scope','$location','userService','GooglePlus','$http','$routeParams', function($scope,$location,userService,GooglePlus,$http,$routeParams) {
    $scope.name= "";
    $scope.rut = "";
    $scope.mail = "";
